...
public:
   ...
   DepthRender() : needResetColorTable(true), color_type(COLORTYPE_BLUERED), range_mode(COLOR_RANGE_DYNAMIC), min_distance(0), max_distance(0), invalid_label(0)
   {
   }
...
private:
   ...
   void HistAdjustRange(const cv::Mat &dist, short invalid, int min_display_distance_range, short &min_val, short &max_val)
   {
